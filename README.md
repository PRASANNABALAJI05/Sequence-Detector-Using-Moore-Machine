...
```verilog
`timescale 1ns / 1ps
module moore_seq_detector(clk,reset,in,out);
input clk,reset,in;
output reg out;
parameter  S0 = 3'b000,
           S1 = 3'b001,
...
reg clk,reset,in;
wire out;
moore_seq_detector uut(clk,reset,in,out);
initial
  begin
   clk=0;
   forever #5 clk=~clk;
...
```
### Simulation Output
<img width="1919" height="1079" alt="Moore_seq" src="https://github.com/user-attachments/assets/07588716-8dcd-4621-93d6-43d859c5b37e" />
